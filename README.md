...
|Actualizar zona horaria| Escenario 17 Actualizar zona horaria|Se realiza el login en el sitio web usando usuario y password, posteriormente se ingresa a la opcion generar y se realizar la actualziacion de la zona horaria
|Actualizar social account| Escenario 18 Actualizar social account|Se realiza el login en el sitio web usando usuario y password, posteriormente se ingresa a la opcion generar y se realizar la actualziacion del social account
|Actualizar Titulo del site| Escenario 19 Actualizar Titulo del site|Se realiza el login en el sitio web usando usuario y password, posteriormente se ingresa a la opcion generar y se realizar la actualziacion del titulo del site
|Actualizar lenguaje del site| Escenario 20 Actualizar lenguaje del site|Se realiza el login en el sitio web usando usuario y password, posteriormente se ingresa a la opcion generar y se realizar la actualziacion del lenguaje del sitio
|Actualizar metadata del site| Escenario 21 Actualizar metadata del site|Se realiza el login en el sitio web usando usuario y password, posteriormente se ingresa a la opcion generar y se realizar la actualziacion de la metadata del sitio.
